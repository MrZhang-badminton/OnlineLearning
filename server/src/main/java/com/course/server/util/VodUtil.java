...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000300823L);
        request.setTemplateGroupId("3aabfbfabdf5242c1ac6540e206f216b");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5t78dNNHBEoa8fdaF1yh";
        //您的AccessKeySecret
        String accessKeySecret = "iAKRIETqqedcZs8y6UZvde5cxtlVVP";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "/Users/zhanghua/Desktop/OnlineLearning/测试文件/image/小节视频/videa111.MP4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
